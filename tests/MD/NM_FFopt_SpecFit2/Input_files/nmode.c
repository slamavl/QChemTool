...
nmode( x, ITEMP( __it0001__, 3 *  *( NAB_mri( m, "natoms" ) ) ), mme2, ITEMP( __it0002__, 1644 ), ITEMP( __it0003__, 0 ), FTEMP( __ft0001__, 0.000000E+00 ), FTEMP( __ft0002__, 0.000000E+00 ), ITEMP( __it0004__, 0 ) );
